...
- **URLs clone dedie (COOLIFY-DEMO-1, nettoye COOLIFY-DEMO-3) :**
  - **URL officielle Guest App : https://demo.hotelmanager.fr/h/demo-paris-local/welcome** (force le slug dans le path, independant des FQDNs)
