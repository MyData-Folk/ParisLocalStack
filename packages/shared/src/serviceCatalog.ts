...
const _defaultSegments = ALL_HOTEL_SEGMENTS;

const ALL_MODULES = {
  wifi_info:        { labelFr: "Wi-Fi",                labelEn: "Wi-Fi",                cat: "reception"      as ServiceCategory, pri: "p3" as ServicePriority, min: "starter"  as CommercialPackage, gv: "low"    as GuestValueLevel, hv: "low"     as HotelValueLevel, cx: "low"   as ImplementationComplexity, dp: "low"      as ServiceCatalogItem["defaultPriority"], pm: false, gvis: true,  rvis: true,  upsell: "Information essentielle pour tout séjour." },
  breakfast_info:   { labelFr: "Petit-déjeuner",       labelEn: "Breakfast",            cat: "food_beverage"  as ServiceCategory, pri: "p3" as ServicePriority, min: "starter"  as CommercialPackage, gv: "medium" as GuestValueLevel, hv: "low"     as HotelValueLevel, cx: "low"   as ImplementationComplexity, dp: "low"      as ServiceCatalogItem["defaultPriority"], pm: false, gvis: true,  rvis: true,  upsell: "Affiché dès le Starter pour rassurer les clients." },
  checkin_checkout: { labelFr: "Check-in / Check-out",  labelEn: "Check-in / Checkout",  cat: "reception"      as ServiceCategory, pri: "p3" as ServicePriority, min: "starter"  as CommercialPackage, gv: "medium" as GuestValueLevel, hv: "low"     as HotelValueLevel, cx: "low"   as ImplementationComplexity, dp: "low"      as ServiceCatalogItem["defaultPriority"], pm: false, gvis: true,  rvis: true,  upsell: "Indispensable pour une arrivée sans friction." },
  taxi:             { labelFr: "Taxi",                  labelEn: "Taxi",                 cat: "transport"      as ServiceCategory, pri: "p1" as ServicePriority, min: "starter"  as CommercialPackage, gv: "very_high" as GuestValueLevel, hv: "high"    as HotelValueLevel, cx: "low"   as ImplementationComplexity, dp: "medium"   as ServiceCatalogItem["defaultPriority"], pm: false, gvis: true,  rvis: true,  upsell: "Service essentiel inclus dès l'offre Starter." },
  airport_transfer: { labelFr: "Transfert aéroport",    labelEn: "Airport Transfer",     cat: "transport"      as ServiceCategory, pri: "p1" as ServicePriority, min: "boutique" as CommercialPackage, gv: "high"   as GuestValueLevel, hv: "high"    as HotelValueLevel, cx: "low"   as ImplementationComplexity, dp: "medium"   as ServiceCatalogItem["defaultPriority"], pm: false, gvis: true,  rvis: true,  upsell: "Service très apprécié des clients internationaux." },
  restaurant_booking:{ labelFr: "Réservation restaurant",labelEn:"Restaurant Booking",   cat: "food_beverage"  as ServiceCategory, pri: "p1" as ServicePriority, min: "boutique" as CommercialPackage, gv: "very_high" as GuestValueLevel, hv: "high"    as HotelValueLevel, cx: "medium" as ImplementationComplexity, dp: "medium"   as ServiceCatalogItem["defaultPriority"], pm: true,  gvis: true,  rvis: true,  upsell: "Permet de valoriser les restaurants partenaires et d'améliorer l'expérience locale." },
  room_service:     { labelFr: "Room service",          labelEn: "Room Service",         cat: "food_beverage"  as ServiceCategory, pri: "p2" as ServicePriority, min: "boutique" as CommercialPackage, gv: "high"   as GuestValueLevel, hv: "medium"  as HotelValueLevel, cx: "low"   as ImplementationComplexity, dp: "medium"   as ServiceCatalogItem["defaultPriority"], pm: false, gvis: true,  rvis: true,  upsell: "Améliore la satisfaction clients sans surcharger la réception." },
  towels:           { labelFr: "Serviettes / Linge",    labelEn: "Towels / Linen",       cat: "housekeeping"   as ServiceCategory, pri: "p1" as ServicePriority, min: "starter"  as CommercialPackage, gv: "medium" as GuestValueLevel, hv: "medium"  as HotelValueLevel, cx: "low"   as ImplementationComplexity, dp: "medium"   as ServiceCatalogItem["defaultPriority"], pm: false, gvis: true,  rvis: true,  upsell: "Service essentiel pour le confort en chambre." },
  housekeeping:     { labelFr: "Ménage",                labelEn: "Housekeeping",         cat: "housekeeping"   as ServiceCategory, pri: "p2" as ServicePriority, min: "boutique" as CommercialPackage, gv: "medium" as GuestValueLevel, hv: "high"    as HotelValueLevel, cx: "low"   as ImplementationComplexity, dp: "medium"   as ServiceCatalogItem["defaultPriority"], pm: false, gvis: true,  rvis: true,  upsell: "Centralise les demandes ménage et réduit les appels." },
  maintenance:      { labelFr: "Maintenance",           labelEn: "Maintenance",          cat: "maintenance"    as ServiceCategory, pri: "p1" as ServicePriority, min: "starter"  as CommercialPackage, gv: "high"   as GuestValueLevel, hv: "very_high" as HotelValueLevel, cx: "medium" as ImplementationComplexity, dp: "urgent"   as ServiceCatalogItem["defaultPriority"], pm: false, gvis: true,  rvis: true,  upsell: "Évite les mauvaises surprises et protège la réputation." },
  reception_assistance:{ labelFr: "Assistance réception",labelEn:"Reception Assistance", cat: "reception"      as ServiceCategory, pri: "p1" as ServicePriority, min: "starter"  as CommercialPackage, gv: "very_high" as GuestValueLevel, hv: "high"    as HotelValueLevel, cx: "low"   as ImplementationComplexity, dp: "urgent"   as ServiceCatalogItem["defaultPriority"], pm: false, gvis: true,  rvis: true,  upsell: "Remonte les demandes urgentes en priorité." },
  luggage_storage:  { labelFr: "Consigne bagages",      labelEn: "Luggage Storage",      cat: "reception"      as ServiceCategory, pri: "p2" as ServicePriority, min: "boutique" as CommercialPackage, gv: "medium" as GuestValueLevel, hv: "low"     as HotelValueLevel, cx: "low"   as ImplementationComplexity, dp: "low"      as ServiceCatalogItem["defaultPriority"], pm: false, gvis: true,  rvis: true,  upsell: "Apprécié pour les arrivées avant check-in ou départs tardifs." },
  late_checkout:    { labelFr: "Late check-out",        labelEn: "Late Check-out",       cat: "reception"      as ServiceCategory, pri: "p2" as ServicePriority, min: "boutique" as CommercialPackage, gv: "high"   as GuestValueLevel, hv: "medium"  as HotelValueLevel, cx: "low"   as ImplementationComplexity, dp: "low"      as ServiceCatalogItem["defaultPriority"], pm: false, gvis: true,  rvis: true,  upsell: "Service différenciant pour une expérience flexible." },
  local_recommendations:{ labelFr: "Recommandations locales",labelEn:"Local Recommendations",cat: "local_guide" as ServiceCategory, pri: "p1" as ServicePriority, min: "boutique" as CommercialPackage, gv: "very_high" as GuestValueLevel, hv: "high"    as HotelValueLevel, cx: "medium" as ImplementationComplexity, dp: "medium"   as ServiceCatalogItem["defaultPriority"], pm: false, gvis: true,  rvis: false, upsell: "Différencie votre hôtel avec un guide local personnalisé." },
  partner_restaurants:{ labelFr: "Restaurants partenaires",labelEn:"Partner Restaurants",cat: "partner"      as ServiceCategory, pri: "p1" as ServicePriority, min: "boutique" as CommercialPackage, gv: "very_high" as GuestValueLevel, hv: "high"    as HotelValueLevel, cx: "medium" as ImplementationComplexity, dp: "medium"   as ServiceCatalogItem["defaultPriority"], pm: true,  gvis: true,  rvis: true,  upsell: "Valorisez vos partenariats restaurateurs dans l'app client." },
  partner_bars:     { labelFr: "Bars partenaires",      labelEn: "Partner Bars",         cat: "partner"        as ServiceCategory, pri: "p2" as ServicePriority, min: "boutique" as CommercialPackage, gv: "medium" as GuestValueLevel, hv: "medium"  as HotelValueLevel, cx: "medium" as ImplementationComplexity, dp: "medium"   as ServiceCatalogItem["defaultPriority"], pm: true,  gvis: true,  rvis: true,  upsell: "Monétisez les établissements du quartier." },
  cruises:          { labelFr: "Croisières",            labelEn: "Cruises",              cat: "partner"        as ServiceCategory, pri: "p2" as ServicePriority, min: "premium"  as CommercialPackage, gv: "high"   as GuestValueLevel, hv: "medium"  as HotelValueLevel, cx: "medium" as ImplementationComplexity, dp: "medium"   as ServiceCatalogItem["defaultPriority"], pm: true,  gvis: true,  rvis: true,  upsell: "Module idéal pour monétiser les partenariats touristiques." },
  bus_tours:        { labelFr: "Tours en bus",          labelEn: "Bus Tours",            cat: "partner"        as ServiceCategory, pri: "p2" as ServicePriority, min: "premium"  as CommercialPackage, gv: "high"   as GuestValueLevel, hv: "medium"  as HotelValueLevel, cx: "medium" as ImplementationComplexity, dp: "medium"   as ServiceCatalogItem["defaultPriority"], pm: true,  gvis: true,  rvis: true,  upsell: "Ajoutez des excursions touristiques à votre offre." },
  museums_tickets:  { labelFr: "Billets musées",        labelEn: "Museum Tickets",       cat: "partner"        as ServiceCategory, pri: "p2" as ServicePriority, min: "premium"  as CommercialPackage, gv: "high"   as GuestValueLevel, hv: "medium"  as HotelValueLevel, cx: "high"  as ImplementationComplexity, dp: "medium"   as ServiceCatalogItem["defaultPriority"], pm: true,  gvis: true,  rvis: true,  upsell: "Service à forte valeur pour les clients culturels." },
  local_experiences:{ labelFr: "Expériences locales",   labelEn: "Local Experiences",    cat: "partner"        as ServiceCategory, pri: "p2" as ServicePriority, min: "premium"  as CommercialPackage, gv: "very_high" as GuestValueLevel, hv: "high"    as HotelValueLevel, cx: "high"  as ImplementationComplexity, dp: "medium"   as ServiceCatalogItem["defaultPriority"], pm: true,  gvis: true,  rvis: true,  upsell: "Différenciation maximale avec expériences uniques." },
  review_feedback:  { labelFr: "Avis satisfaction",     labelEn: "Review Feedback",      cat: "feedback"       as ServiceCategory, pri: "p1" as ServicePriority, min: "starter"  as CommercialPackage, gv: "high"   as GuestValueLevel, hv: "very_high" as HotelValueLevel, cx: "low"   as ImplementationComplexity, dp: "high"     as ServiceCatalogItem["defaultPriority"], pm: false, gvis: true,  rvis: true,  upsell: "Captez les avis avant qu'ils n'arrivent sur les plateformes publiques." },
  crm_collection:   { labelFr: "Collecte CRM",          labelEn: "CRM Collection",       cat: "crm"            as ServiceCategory, pri: "p1" as ServicePriority, min: "starter"  as CommercialPackage, gv: "low"    as GuestValueLevel, hv: "very_high" as HotelValueLevel, cx: "low"   as ImplementationComplexity, dp: "low"      as ServiceCatalogItem["defaultPriority"], pm: false, gvis: false, rvis: true,  upsell: "Construisez votre base CRM sans effort." },
  post_stay_followup:{ labelFr: "Suivi post-séjour",    labelEn: "Post-Stay Follow-up",  cat: "crm"            as ServiceCategory, pri: "p2" as ServicePriority, min: "boutique" as CommercialPackage, gv: "high"   as GuestValueLevel, hv: "high"    as HotelValueLevel, cx: "medium" as ImplementationComplexity, dp: "medium"   as ServiceCatalogItem["defaultPriority"], pm: false, gvis: false, rvis: true,  upsell: "Fidélisez vos clients après leur départ." },
  analytics_dashboard:{ labelFr: "Analytics dashboard", labelEn: "Analytics Dashboard",  cat: "crm"            as ServiceCategory, pri: "p2" as ServicePriority, min: "premium"  as CommercialPackage, gv: "low"    as GuestValueLevel, hv: "very_high" as HotelValueLevel, cx: "high"  as ImplementationComplexity, dp: "low"      as ServiceCatalogItem["defaultPriority"], pm: false, gvis: false, rvis: true,  upsell: "Pilotez votre hôtel avec des données de satisfaction et d'usage." },
} as const;

function buildCatalogItem(
  id: ServiceId,
  m: typeof ALL_MODULES[ServiceId],
  formFields: readonly ServiceFieldDefinition[],
  receptionDisplay: readonly ReceptionDisplayField[]
): ServiceCatalogItem {
  return {
    ...
    priority: m.pri,
    minPackage: m.min,
    hotelSegments: _defaultSegments,
    guestValue: m.gv,
    hotelValue: m.hv,
    complexity: m.cx,
